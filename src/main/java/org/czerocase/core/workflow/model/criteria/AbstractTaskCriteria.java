...
public abstract class AbstractTaskCriteria implements TaskCriteria{
	private static int DEFAULT_MAX_RESULTS = 100;
	private List<TaskFilter> filters;
	private int maxResults;
	private Object workflowSession;
	
	public AbstractTaskCriteria(Object workflowSession,List<TaskFilter> filters,int maxResults) {
		this.workflowSession = workflowSession;
		this.filters = filters;
		this.maxResults = maxResults;
	}

	public AbstractTaskCriteria(List<TaskFilter> filters, int maxResults) {
		this.filters = filters;
		this.maxResults = maxResults;
	}

	public AbstractTaskCriteria(List<TaskFilter> filters) {
		this.filters = filters;
		this.maxResults = DEFAULT_MAX_RESULTS;
	}
	
	public AbstractTaskCriteria() {
		this.maxResults = DEFAULT_MAX_RESULTS;
