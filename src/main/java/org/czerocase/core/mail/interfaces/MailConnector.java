...
package org.czerocase.core.mail.interfaces;


import java.util.List;

import org.czerocase.core.mail.exceptions.MailException;
import org.czerocase.core.mail.model.Account;
import org.czerocase.core.mail.model.Attachment;
import org.czerocase.core.mail.model.Mail;

public interface MailConnector {
    
    public void send(Mail mail, Account account) throws MailException;

    public List<Mail> getEmail(Account account) throws MailException;
    
    public boolean addAllegato(Attachment attachment) throws MailException;
    
    public boolean addAllegati(List<Attachment> attachments) throws MailException;
