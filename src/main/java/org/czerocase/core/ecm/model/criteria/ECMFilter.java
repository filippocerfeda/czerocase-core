...
public class ECMFilter {
	private Attribute<?> filter;
	private ECMCriteriaOperator operator;
	
	public ECMFilter(Attribute<?> filter,ECMCriteriaOperator operator){
		this.filter = filter;
	...
	public ECMCriteriaOperator getOperator() {
		return operator;
	}

	public void setOperator(ECMCriteriaOperator operator) {
		this.operator = operator;
	}
